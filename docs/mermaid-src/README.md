...
| File | Diagram |
|------|---------|
| `recipe-overview.mmd` | Complete chemistry recipe pathway flowchart (276 recipes + botanical ref) |
| `botanical-pathways.mmd` | Botanical & horticulture pathway flowchart (31 recipes + 31 horticulture items) |
