...
| File | Diagram |
|------|---------|
| `recipe-overview.mmd` | Complete chemistry recipe pathway flowchart (301 recipes + botanical ref) |
| `botanical-pathways.mmd` | Botanical & horticulture pathway flowchart (37 recipes + 45 horticulture items) |
